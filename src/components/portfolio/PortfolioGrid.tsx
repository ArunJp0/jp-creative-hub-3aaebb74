  ...
  web: [
    {
      ...
      impact: "Professional online presence for local business",
    },
    {
      title: "Adyar Academy",
      ...
      impact: "Streamlined student enrollment process",
    },
    {
      ...
      impact: "Showcase of React development skills",
    },
    {
  ...
  data: [
    {
      ...
      impact: "Identified key delivery optimization opportunities",
    },
    {
      ...
      impact: "Clear insights for claims management",
    },
    {
      ...
      impact: "Data-driven inventory decisions",
    },
    {
      ...
      tech: ["Power BI", "Excel"],
      icon: BarChart3,
      impact: "Improved sales team performance tracking",
    },
  ],
  marketing: [
    {
      ...
      icon: TrendingUp,
      impact: "35% increase in bookings",
    },
    {
      ...
      icon: TrendingUp,
      impact: "Expanded reach across multiple markets",
    },
  ],
};
...
const ProjectCard = ({ project, index, isInView }: ProjectCardProps) => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="bg-card rounded-2xl p-6 border border-border hover:border-primary transition-all duration-300 hover:shadow-glow h-full flex flex-col">
        ...
        {project.impact && (
          <div className="bg-secondary/50 rounded-lg p-3 mb-4">
            <p className="text-sm text-primary font-medium">Impact: {project.impact}</p>
          </div>
        )}
