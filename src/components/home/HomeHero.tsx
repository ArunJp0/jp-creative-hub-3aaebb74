        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          duration: 0.8
            ...
            <div className="relative">
              ...
              <img alt="Freelance Web Developer in Salem - Arunprasath" className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover object-center border-4 border-primary shadow-glow" src="/lovable-uploads/d5003cad-6c88-45be-b3d4-910ebc8ef81f.png" />
            </div>
          </motion.div>
        </div>
      </div>
